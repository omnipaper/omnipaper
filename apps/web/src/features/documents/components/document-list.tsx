...
// list view owns that search param). `initialSearch` seeds from the URL for deep-links.
export function DocumentList({
  ...
  // Keep the latest callback without making it a debounce dependency (avoids resetting the timer
  // when the route passes a fresh function identity each render).
  ...
  if (isPending) {
    ...
    content = <DocumentRows orgId={orgId} documents={data.documents} />;
  }
